...
module.exports = function(defaultFuncs, api, ctx) {
  return function logout(callback) {
    ...
    defaultFuncs
	  ...
	  // var elemBeforeFilter = resData.jsmods.instances[0][2][0];
		// console.log("elemBeforeFilterelemBeforeFilterelemBeforeFilterelemBeforeFilterelemBeforeFilter");
	  // console.log(elemBeforeFilter);
        var elem = resData.jsmods.instances[0][2][0].filter(function(v) {
          return v.value === "logout";
        })[0];
		// console.log("ELEM!!!ELEM!!!ELEM!!!ELEM!!!ELEM!!!");
		// 	console.log(elem);
			console.log("HTML!!22222!!HTML!!!!HTML!!!!HTML!!!!HTML!!!!HTML!!!!HTML!!!!");
        var html = resData.jsmods.markup.filter(function(v) {
          return v[0] === elem.markup.__m;
        })[0][1].__html;
			console.log("HTML!!33333!!HTML!!!!HTML!!!!HTML!!!!HTML!!!!HTML!!!!HTML!!!!");
			console.log(html);
        var form = {
