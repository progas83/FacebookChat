...
var ebcoddded = encodeURIComponent(str);
console.log("Encodedd:");
console.log(ebcoddded);
  var replaceFirst = ebcoddded.replace(/([_A-Z])|%../g,function(m, n) {
				return n ? '%' + n.charCodeAt(0).toString(16) : m;});
console.log("ReplaceFirst = ");
console.log(replaceFirst);
				var tttLower = replaceFirst.toLowerCase();
				console.log("ToLower ");
console.log(tttLower);
				var replaceSecond = replaceFirst.toLowerCase().replace(h, function(m) {
    return i[m];
  });
...
console.log("Correct presense encode:");
console.log(presenceEncode1(str));			
return replaceSecond;
}
...
function generatePresence(userID) {
  var time = Date.now();
  // console.log("Into Generate ========================================== Presence");
  // console.log(time);
  // console.log(parseInt(time / 1000, 10));
  // var mRes = Math.floor(Math.random() * 4294967295) + 1;
  // console.log(mRes);
  
  // var jsResu = JSON.stringify(
  // {
    // "v": 3,
...
function generateAccessiblityCookie() {
 ...
 // console.log("Access!!Access!!Access!!Access!!Access!!Access!!Access!!Access!!Access!!Access!!Access!!Access!!");/////
//	console.log(accCookie);
